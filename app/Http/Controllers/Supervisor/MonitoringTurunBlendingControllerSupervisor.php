...
class MonitoringTurunBlendingControllerSupervisor extends Controller
{
    //
    public function dashboard()
    {
        ...
        return view('supervisor.monitoring.dashboard_turun');
    }
    public function menu()
    {
        // Menampilkan view 'productionbatch.index' dengan data
        return view('supervisor.monitoring.menu');
    }
    ...
    public function store_data_supervisor(Request $request)
    {
        // Validasi input
        $validator = Validator::make($request->all(), [
    ...
    public function showDataDetail($id)
    {
        ...
        $datasupervisor = MonitoringTurunBlendingData::where('monitoring_turun_blending_id', $id)->get();
