...
class MonitoringStorageControllerSupervisor extends Controller
{
    //
    ...
    public function Monitoring_Storage_detail_mikro($id)
    {
        ...
        return view('supervisor.monitoring.monitoring_storage.detail_data_mikro', [
            'productionBatch' => $productionBatch,
    ...
    public function Monitoring_Storage_detail_mikro_id($id)
    {
        ...
        $data = MonitoringStorageModel::find($id);
        return view('supervisor.monitoring.monitoring_storage.analisis_data_detail_mikro_id', compact('data'));
    }
    ...
    public function showInputFormMonitoringStorage($id)
    {
        ...
        return view('supervisor.monitoring_storage.monitoring_storage_detail_id', compact('monitoring_storage'));
    }

    public function showInputFormMonitoringStorageMikro($id)
    {
        $monitoring_storage = MonitoringStorageMikroModel::find($id);
        return view('supervisor.monitoring_storage.monitoring_storage_detail_mikro_id', compact('monitoring_storage'));
    }
