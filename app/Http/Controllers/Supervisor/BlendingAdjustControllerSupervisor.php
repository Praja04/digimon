...
class BlendingAdjustControllerSupervisor extends Controller
{
    //
    public function dashboard()
    {
        ...
        return view('supervisor.blending.dashboard_blending_after');
    }
    public function Blending_adjust_data()
    {
        ...
        return view('supervisor.blending.blending_adjust', compact('productionBatches'));
    }
    ...
    public function Blending_adjust_data_mikro()
    {
        ...
        return view('supervisor.blending.blending_adjust_mikro', compact('productionBatches'));
    }
    ...
    public function Blending_detail($id)
    {
       ...
       // return response()->json($filteredblendingAfterAdjust->values());
        return view('supervisor.blending.blending_adjust_detail', [
    ...
    public function Blending_detail_mikro($id)
    {
        ...
        return view('supervisor.blending.blending_adjust_detail_mikro', [
            'productionBatch' => $productionBatch,
        ]);
    }
    ...
    public function showInputFormBlendingAdjust($id)
    {
        ...
        return view('supervisor.blending.blending_adjust_detail_id', compact('blending'));
    }

    public function showInputFormBlendingAdjustMikro($id)
    {
        $blending = BlendingAfterAdjustMikroModel::find($id);
        return view('supervisor.blending.blending_adjust_detail_mikro_id', compact('blending'));
    }
