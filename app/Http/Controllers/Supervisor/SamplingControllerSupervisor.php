...
class SamplingControllerSupervisor extends Controller
{
    ...
    public function showKondisiMobil($id)
    {
        ...
        if ($samplingExists) {
            return view('supervisor.sampling.kondisi_mobil', [
        ...
        return view('supervisor.sampling.kondisi_mobil', compact('identitas', 'samplingExists'));
    }
    ...
    public function showDokumen($id)
    {
        ...
        return view('supervisor.sampling.dokumen', compact('id'));
    }
    ...
    public function showFisikKemasan($id)
    {
        ...
        return view('supervisor.sampling.fisik_kemasan', compact('id'));
    }
    ...
    public function showFisikRaw($id)
    {
        ...
        return view('supervisor.sampling.fisik_raw', compact('id'));
    }
