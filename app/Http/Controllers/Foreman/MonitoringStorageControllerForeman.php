...
class MonitoringStorageControllerForeman extends Controller
{
    //
    public function dashboard()
    {
        ...
        return view('foreman.monitoring.monitoring_storage.dashboard_storage');
    }
    ...
    public function Monitoring_Storage_detail_mikro($id)
    {
        ...
        return view('foreman.monitoring.monitoring_storage.detail_data_mikro', [
            'productionBatch' => $productionBatch,
    ...
    public function Monitoring_Storage_detail_mikro_id($id)
    {
        ...
        $data = MonitoringStorageModel::find($id);
        return view('foreman.monitoring.monitoring_storage.analisis_data_detail_mikro_id', compact('data'));
    }
    ...
    public function edit_monitoring_storage_makro(Request $request, $id)
    {
        $validator = Validator::make($request->all(), [
    ...
    public function showInputFormMonitoringStorage($id)
    {
        ...
        return view('foreman.monitoring_storage.monitoring_storage_detail_id', compact('monitoring_storage'));
    }

    public function showInputFormMonitoringStorageMikro($id)
    {
        $monitoring_storage = MonitoringStorageMikroModel::find($id);
        return view('foreman.monitoring_storage.monitoring_storage_detail_mikro_id', compact('monitoring_storage'));
    }
    ...
    public function edit_monitoring_storage_mikro(Request $request, $id)
    {
        $validator = Validator::make($request->all(), [
            ...
            'ym_eidt' => 'nullable |string|max:20',
        ]);
