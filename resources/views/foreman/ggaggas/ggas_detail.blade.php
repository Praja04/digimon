                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    Adjustment Air: {{ $ggas->adjustment_qty_air }} Liter, Garam: {{ $ggas->adjustment_qty_garam }} Kg, Gula: {{ $ggas->adjustment_qty_gula }} Kg
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary open-ggas-modal-edit" data-id="{{ $ggas->id }}" data-bs-toggle="modal" data-bs-target="#editGgasModal">
                                        Edit GGAS
                                    </button>
                                    @endif
                            ...
                            <div class="modal fade" id="editGgasModal" tabindex="-1" aria-labelledby="editGgasModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
...
<script>
    $(document).ready(function() {
        ...
        $('.open-ggas-modal-edit').on('click', function() {
            selectedId = $(this).data('id');
        });
