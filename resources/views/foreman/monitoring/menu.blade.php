        ...
        <div class="col-xl-6 col-lg-4">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <div class="mt-4">
                        <a href="{{ url('foreman/monitoring/blending/data') }}" class="btn btn-light w-100">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-4">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <div class="mt-4">
                        <div class="mt-4">
                            <a href="{{ url('foreman/monitoring/storage/data') }}" class="btn btn-light w-100">Lihat
                                Detail</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-6 col-lg-4">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    ...
                    <div class="mt-4">
                        <div class="mt-4">
                            <a href="{{ url('foreman/monitoring/storage/data/mikro') }}" class="btn btn-light w-100">Lihat
                                Detail</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-6 col-lg-4">
            <div class="card ribbon-box right overflow-hidden">
                <div class="card-body text-center p-4">
                    <div class="ribbon ribbon-warning ribbon-shape trending-ribbon">
                        <i class="ri-hand-heart-fill text-white align-bottom"></i>
                        <span class="trending-ribbon-text">Pasteurisasi</span>
                    </div>
                    <img src="{{ asset('assets/images/blending_adjust.png') }}" alt="gambar" height="100">
                    <h5 class="mb-1 mt-4"><a href="" class="link-primary">Data Monitoring Pasteurisasi</a></h5>
                    <p class="text-muted mb-4">Analisis Monitoring Pasteurisasi</p>
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div id="chart-ggas" data-colors='["--vz-danger"]'></div>
                        </div>
                    ...
                    <div class="mt-4">
                        <div class="mt-4">
                            <a href="{{ url('foreman/monitoring/pasteurisasi/data') }}" class="btn btn-light w-100">Lihat
                                Detail</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center">
                ...
                <div class="modal-body">
                    <img src="{{ asset('assets/images/comingsoon.png') }}" alt="Coming Soon" height="80"
                        class="mb-3">
