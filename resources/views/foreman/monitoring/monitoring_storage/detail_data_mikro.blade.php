                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <button class="btn btn-sm btn-warning open-modal-edit"
                                                        data-id="{{ $data->id }}" data-eb="{{ $data->eb }}"
                                                        data-tpc="{{ $data->tpc }}"
                                                        data-ym="{{ $data->ym }}">Edit Data</button>
                                                @endif
                                            </td>
                                            <td>{{ $data->hasil ?? '-' }}</td>
                                        </tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">EB</label>
                                                        <input type="number" step="0.01" max="100"
                                                            min="0" name="eb_edit" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">TPC</label>
                                                        <input type="number" step="0.01" max="100"
                                                            min="0" name="tpc_edit" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">YM</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.open-modal-edit').on('click', function() {
                selectedId = $(this).data('id');
                $('#id_edit').val(selectedId);
                $('[name="eb_edit"]').val($(this).data('eb'));
                $('[name="tpc_edit"]').val($(this).data('tpc'));
                $('[name="ym_edit"]').val($(this).data('ym'));
            ...
            $('#monitoring_form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('/foreman/monitoring/storage/update/data/mikro') }}/" +
                        selectedId,
                    method: 'POST',
                    data: form.serialize(),
