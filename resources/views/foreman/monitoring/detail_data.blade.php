        ...
        <div class="card" id="tasksList">
            ...
            <div class="card-body">
                <div class="table-responsive table-card mb-4">
                    ...
                    <div class="modal fade" id="modalEditMonitoring" tabindex="-1" aria-labelledby="modalEditMonitoringLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="{{ $field }}_edit" id="edit-{{ $field }}" class="form-control">
                                        </div>
                                        @endforeach
