...
@section('content')
    ...
    <script>
                    ...
                    if (res.success && res.data.length > 0) {
                        ...
                        res.data.forEach(item => {
                            const option = $('<option></option>')
                                .val(item.nama_warna)
                                .text(item.nama_warna + ' (' + item.nama_warna + ')');
        ...
        $(document).on('click', '.open-edit', function() {
            ...
            $('#modalDataMonitoring').modal('hide'); // tutup modal detail
        ...
        $(document).ready(function() {
            ...
            $('.btn-lihat').on('click', function() {
                ...
                $.ajax({
                    url: "{{ url('foreman/monitoring/blending/detail/data') }}" + '/' + id,
                    type: 'GET',
                    dataType: 'json',
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive mt-3">
                        ...
                        <tr>
                            ...
                            html +=
                                `<tr><td colspan="12" class="text-center">Belum ada data analisa</td></tr>`;
                        }
            ...
            $('#form-monitoring-input').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('foreman/monitoring/blending/detail/data') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
            ...
            $('#turunblendingForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('/foreman/monitoring/blending/update/data') }}",
                    method: 'POST',
                    data: form.serialize(),
                    success: function(response) {
            ...
            $('#formEditMonitoring').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('foreman/monitoring/blending/detail/edit') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
