            ...
            <div class="card" id="dataRMCard">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-xxl-3 col-sm-3">
                                <div class="search-box">
                                    <input type="text" class="form-control" id="searchDataRM"
                                        placeholder="Cari nama bahan, SPB, atau suplier...">
                ...
                <div class="card-body pt-0">
                    <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active py-2" data-bs-toggle="tab" href="#tabAll" role="tab">🧾 Semua Data
                                RM</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-2" data-bs-toggle="tab" href="#gulakelapa" role="tab">Gula
                                Kelapa</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $tabId }}"
                                ...
                                <div class="table-responsive table-card">
                                    ...
                                    <nav class="mt-2 text-center">
                                        <ul class="pagination justify-content-center" id="pagination{{ $tabId }}">
                                        </ul>
                                    </nav>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('rmpm.simpanIdentitas') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="suplier_manufactur"
                                        name="suplier_manufactur" required>
                                </div>
     ...
     `);
      ...
      `);
        ...
        function showQrModal(id, label) {
            ...
            const urlToEncode = `${window.location.origin}/foreman/rmpm/detail/data/${id}`;
