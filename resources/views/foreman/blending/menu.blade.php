    ...
    <div class="col-xl-4 col-lg-4">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-4">
                    <a href="{{url('foreman/blending/awal')}}" class="btn btn-light w-100">Lihat Detail</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-4">
                        <a href="{{url('foreman/blending/adjust/data')}}" class="btn btn-light w-100">Lihat Detail</a>
                    </div>

                    <!-- <a href="{{url('foreman/ggaggas/ggas')}}" class="btn btn-light w-100">Lihat Detail</a> -->
                </div>
            </div>
        </div>
    </div>
