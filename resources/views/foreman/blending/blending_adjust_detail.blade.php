                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-primary open-blending-modal-edit" data-id="{{ $item->id }}">Edit</button>
                                    @endif
                            ...
                            <div class="modal fade" id="editBlendingModal" tabindex="-1" aria-labelledby="editBlendingModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form id="blendingFormEdit">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Data Blending After Adjustment</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="alert alert-danger d-none error-alert"></div>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Bj</label>
                                                    <input type="number" name="bj_edit" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Visco</label>
                                                    <input type="number" name="visco_edit" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Aw</label>
                                                    <input type="number" name="aw_edit" class="form-control" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Buih</label>
                                                    <input type="number" name="buih_edit" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Organo</label>
                                                    <input type="text" name="organo_edit" class="form-control" required oninput="this.value = this.value.toUpperCase();">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Endapan</label>
                                                    <input type="text" name="endapan_edit" class="form-control" oninput="this.value = this.value.toUpperCase();">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Warna</label>
                                                    <!-- <input type="text" name="warna_edit" class="form-control" required oninput="this.value = this.value.toUpperCase();"> -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#blendingForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('/foreman/blending/adjust/update')}}/" + selectedId,
                method: 'POST',
                data: form.serialize(),
        ...
        $('#blendingFormEdit').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('/foreman/blending/adjust/edit')}}/" + selectedId,
                method: 'POST',
                data: form.serialize(),
                success: function(response) {
                    $('#inputBlendingModal').modal('hide');
