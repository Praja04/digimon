...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-gradient-primary rounded-3 p-4 mb-4 shadow-sm">
            <div>
                <h4 class="mb-1 text-white fw-bold">Monitoring Storage Mikro</h4>
                <p class="text-white-75 mb-0">Comprehensive monitoring storage mikro analysis</p>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        async function loadParameters() {
            try {
                ...
                const mikroData = data.monitoring_storage_mikro || [];
                ...
                console.error("Error loading storage mikro parameters:", err);
            }
        }
