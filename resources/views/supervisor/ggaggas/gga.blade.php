                        ...
                        <table class="table align-middle text-center" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $batch->GgaProcesses->count() }}</td>
                                    <td>{{ $batch->isGGaComplete() ? '✅ Complete' : '⌛ Progress' }}</td>
                                    <td>
                                        <a href="{{ url('supervisor/ggaggas/gga/' . $batch->id) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
