                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td class="disposisi_short_term">
                                        @php
                                        $short = $data_detail3[$identitas->id]->disposisi->disposisi ?? null;
                                        @endphp
                                        @if ($short === 'Reject')
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('rmpm_supervisor.detail_data', ['id' => $identitas->id]) }}" class="btn btn-sm btn-info">
        ...
        $('#updateDisposisiForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    setTimeout(() => location.reload(), 1000); // reload halaman setelah 1 detik
                },
                error: function(xhr) {
