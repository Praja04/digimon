                        ...
                        <table class="table align-middle text-center" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $batch->MonitoringTurunBlending ->count() }}</td>
                                    <td>{{ $batch->isMonitoringBlendingComplete() ? '✅ Complete' : '⌛ Progress' }}</td>

                                    <td>
                                        <a href="{{ url('supervisor/monitoring/blending/detail/' . $batch->id) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
