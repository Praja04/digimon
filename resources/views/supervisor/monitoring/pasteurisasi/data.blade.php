                                ...
                                <tbody class="list form-check-all">
                                    @forelse ($productionBatches as $batch)
                                        <tr>
                                            ...
                                            <td>{{ $batch->MonitoringPasteurisasi->count() }}</td>
                                            <td>{{ $batch->isMonitoringPasteurisasiComplete() ? '✅ Complete' : '⌛ Progress' }}
                                            </td>

                                            <td>
                                                <a href="{{ url('supervisor/monitoring/pasteurisasi/detail/' . $batch->id) }}"
