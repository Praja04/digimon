    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-lihat').on('click', function() {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/pasteurisasi/detail/data') }}" + '/' + id,
                    type: 'GET',
                    dataType: 'json',
            ...
            $('#form-monitoring-input').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/pasteurisasi/detail/data') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
            ...
            $('#formEditMonitoring').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/pasteurisasi/detail/edit') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
