    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Input Monitoring Pasteurisasi</h4>
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="hstack gap-3 flex-wrap">
                                                    ...
                                                    <div class="text-muted">Tanggal Produksi : <span
                                                            class="text-body fw-medium">{{ $monitoring->ProductionBatch->production_date }}</span>
                                                    </div>
                                                    <div class="text-end">
                                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#inputModalDataAnalisa">
                                                            Input Data Analisa
                                                        </button>
                                                    </div>
                                                    <div class="text-end">
                                                        <button class="btn btn-warning" data-bs-toggle="modal"
                                                            data-bs-target="#inputModalDataDisposisi">
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ $monitoring->ProductionBatch->variant }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">
                                                                {{ $monitoring->ProductionBatch->batch_range }}</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">{{ $monitoring->ProductionBatch->storage }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="nav nav-tabs nav-tabs-custom nav-success" id="nav-tab"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab"
                                                            ...
                                                            aria-selected="true">Monitoring Blending</a>
                                                    </li>
                                            ...
                                            <div class="tab-content border border-top-0 p-4" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="nav-speci" role="tabpanel"
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        @if ($monitoring->monitoringPasteurisasiData->count() > 0)
                                                            <table class="table mb-0">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($monitoring->monitoringPasteurisasiData as $data)
                                                                        <tr>
                                                                            <td>{{ $data->shift }}</td>
                                                                            <td>{{ $data->brix }}</td>
                                                                            <td>{{ $data->nacl }}</td>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button> {{-- tombol silang --}}
                        </div>
                        <div class="modal-body row g-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#form-monitoring-input').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/pasteurisasi/detail/data') }}", // Ganti sesuai route
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
            ...
            $('#pasteurisasiForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('/supervisor/monitoring/pasteurisasi/update/data') }}",
                    method: 'POST',
                    data: form.serialize(),
                    success: function(response) {
