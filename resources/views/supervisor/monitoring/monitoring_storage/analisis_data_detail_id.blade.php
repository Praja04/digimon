...
<script>
    $(document).ready(function() {
        ...
        $('.form-data').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('supervisor/monitoring/storage/update/data')}}/" + id,
                method: 'POST',
                data: form.serialize(),
                success: function(response) {
                    Swal.fire({
                        ...
                        window.location.href = "{{ url('/supervsor/monitoring/storage/detail') }}/" + url;
                    });
                },
                error: function(xhr) {
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ url('/supervisor/monitoring/storage/detail') }}/" + url;
                    }, 3000);
