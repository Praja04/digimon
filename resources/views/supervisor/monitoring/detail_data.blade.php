                        ...
                        <div class="modal fade" id="modalMonitoring" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" id="modal-content-monitoring">
                                    ...
                                    <form id="form-monitoring-input" method="POST">
                                        @csrf
                                        ...
                                        <div class="modal-body row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="brix" id="brix"
                                                    required>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="nacl" class="form-label">NaCl</label>
                                                <input type="text" class="form-control" name="nacl" id="nacl"
                                                    required>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="bj" class="form-label">BJ</label>
                                                <input type="text" class="form-control" name="bj" id="bj"
                                                    required>
                                            </div>

                                            <div class="col-md-4">
                                                <label for="visco" class="form-label">Visco</label>
                                                <input type="text" class="form-control" name="visco"
                                                    id="visco">
                                            </div>

                                            <div class="col-md-4">
                                                <label for="aw" class="form-label">AW</label>
                                                <input type="text" class="form-control" name="aw"
                                                    id="aw">
                                            </div>

                                            <div class="col-md-4">
                                                <label for="buih" class="form-label">Buih</label>
                                                <input type="text" class="form-control" name="buih"
                                                    id="buih">
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-lihat').on('click', function() {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/blending/detail/data') }}" + '/' + id,
                    type: 'GET',
                    dataType: 'json',
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive mt-3">
                        ...
                        if (response.datasupervisor.length > 0) {
                            response.datasupervisor.forEach(function(data) {
                                html += `
                        <tr>
                            <td>${data.shift ?? '-'}</td>
                            <td>${data.brix ?? '-'}</td>
            ...
            $('#form-monitoring-input').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('supervisor/monitoring/blending/detail/data') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
