    ...
    <div class="col-xl-4 col-lg-4">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-4">
                    <a href="{{url('supervisor/monitoring/blending/data')}}" class="btn btn-light w-100">Lihat Detail</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-4 col-lg-4">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-4">
                    <div class="mt-4">
                        <a href="{{url('supervisor/monitoring/storage/data')}}" class="btn btn-light w-100">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-4 col-lg-4">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <div class="mt-4">
                    <div class="mt-4">
                        <a href="{{url('supervisor/monitoring/storage/data/mikro')}}" class="btn btn-light w-100">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
