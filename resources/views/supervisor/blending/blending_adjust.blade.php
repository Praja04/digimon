                        ...
                        <table class="table align-middle text-center" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $batch->blendingAfterAdjust ->count() }}</td>
                                    <td>{{ $batch->isBlendingAdjustMakroComplete() ? '✅ Complete' : '⌛ Progress' }}</td>

                                    <td>
                                        <a href="{{ url('supervisor/blending/adjust/detail/' . $batch->id) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
