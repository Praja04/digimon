                        ...
                        <table class="table align-middle text-center" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $batch->BlendingAwal->count() }}</td>
                                    <td>{{ $batch->isBlendingAwalComplete() ? '✅ Complete' : '⌛ Progress' }}</td>

                                    <td>
                                        <a href="{{ url('supervisor/blending/awal/detail/' . $batch->id) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
