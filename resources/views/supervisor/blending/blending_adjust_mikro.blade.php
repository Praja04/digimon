...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Blending After Adjustment - Mikro</h4>
                        ...
                        <table class="table align-middle text-center" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $batch->blendingAfterAdjustMikro ->count() }}</td>
                                    <td>{{ $batch->isBlendingAdjustMikroComplete() ? '✅ Complete' : '⌛ Progress' }}</td>

                                    <td>
                                        <a href="{{ url('supervisor/blending/mikro/detail/' . $batch->id) }}" class="btn btn-sm btn-primary">View</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
