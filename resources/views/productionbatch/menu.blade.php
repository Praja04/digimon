                ...
                <div class="position-relative overflow-hidden">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <div
                                    class="avatar-lg bg-light border rounded-4 d-flex align-items-center justify-content-center">
                                    <img src="{{ asset('assets/images/blending_adjust.png') }}" alt="Monitoring Blending"
                                        class="rounded-3" height="60" style="object-fit: cover;">
                                </div>
                            </div>
                            <div class="col-8">
                                <h5 class="mb-2 fw-semibold">
