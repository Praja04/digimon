                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($productionBatches as $index => $productionBatch)
                                        <tr>
                                            ...
                                            <td>{{ $productionBatch->isMonitoringStorageBeforeUseComplete() ? '✅ Complete' : '⌛ Progress' }}
                                            </td>
                                            <td>
                                                <a href="{{ route('productionbatch.show_monitoring_storage_before_use', $productionBatch->id) }}"
