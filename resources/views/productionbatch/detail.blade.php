                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            data-bs-target="#qrModal{{ $gga->id }}">
                                                                            QR Code {{ $gga->id }}
                                                                        </button>

                                                                        <!-- Modal Besar -->
                                                                        <div class="modal fade"
                                                                            id="qrModal{{ $gga->id }}" tabindex="-1"
                                                                            aria-labelledby="qrModalLabel{{ $gga->id }}"
                                                                            aria-hidden="true">
                                                                            <div
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body text-center"
                                                                                        id="qrPrintArea{{ $gga->id }}">
                                                                                        <div
                                                                                            style="display: inline-block;">
                                                                                            <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG(url('/analis/ggaggas/gga/id/' . $gga->id), 'QRCODE') }}"
                                                                                                alt="QR Code">
                                                                                        </div>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <button
                                                                                            onclick="printQR('qrPrintArea{{ $gga->id }}')"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if (in_array($gga->disposition, ['Adjustment', 'Resampling']) && $gga->revisi == null && $gga->not_standar == true)
                                                                            <button
                                                                                ...
                                                                                data-id="{{ $gga->id }}"
                                                                                data-batch="{{ $gga->batch_number }}"
                                                                                data-po="{{ $gga->production_batch_id }}"
                                                                                data-dissolver="{{ $gga->dissolver_number }}">
                                                                                ❗
                                                                            </button>
                                                                        @endif
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @elseif($gga->disposition == 'Adjustment')
                                                                            Adjustment Air: {{ $gga->adjustment_qty_air }}
                                                                            Liter, Garam: {{ $gga->adjustment_qty_garam }}
                                                                            Kg, Gula: {{ $gga->adjustment_qty_gula }} Kg
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="modal fade"
                                                                            ...
                                                                            tabindex="-1"
                                                                            aria-labelledby="qrModalLabel{{ $ggas->id }}"
                                                                            aria-hidden="true">
                                                                            <div
                                                                                class="modal-dialog modal-dialog-centered modal-lg">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div
                                                                                        class="modal-footer justify-content-center py-2">
                                                                                        <button
                                                                                            onclick="printQR('qrPrintArea{{ $ggas->id }}')"
                                                                                            class="btn btn-sm btn-success">Print</button>
                                                                                        <button type="button"
                                                                                            class="btn btn-sm btn-secondary"
                                                                                            data-bs-dismiss="modal">Close</button>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if (in_array($ggas->disposition, ['Adjustment', 'Resampling']) && $ggas->revisi == null && $ggas->not_standar == true)
                                                                            <button
                                                                                class="btn btn-sm btn-warning generate-revisi-btn-ggas"
                                                                                data-id="{{ $ggas->id }}"
                                                                                data-batch="{{ $ggas->batch_number }}"
                                                                                data-po="{{ $ggas->production_batch_id }}"
                                                                                data-dissolver="{{ $ggas->dissolver_number }}">
                                                                                ❗
                                                                            </button>
                                                                        @endif
                                                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="modal_revisi_display" name="revisi_gga"
                                readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <form id="generateRevisiFormGGAS">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Batch</label>
                            <input type="text" class="form-control" id="modal_batch_ggas" name="batch_number_ggas"
                                readonly>
                        </div>
                        <div class="mb-3">
                            <label>Revisi Ke-</label>
                            <input type="text" class="form-control" id="modal_revisi_display_ggas" name="revisi_ggas"
                                readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
