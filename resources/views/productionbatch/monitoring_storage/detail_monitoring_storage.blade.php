...
@section('content')
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                @if ($productionBatch->MonitoringStorage->count() > 0)
                                                    <table class="table mb-0">
                                                        ...
                                                        <tbody>
                                                            @foreach ($productionBatch->MonitoringStorage as $blending)
                                                                <tr>
                                                                    <td>{{ $blending->batch_range }}
                                                                        @if ($blending->has_relation == true)
                                                                            <span class="badge bg-info text-dark ms-2">
                                                                                Merge {{ $blending->related_batches }}
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body text-center"
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG(url('analis/monitoring/storage/detail/data/' . $blending->id), 'QRCODE') }}"
                                                                                                alt="QR Code">
                                                                                        </div>
                                                                                        <p>Monitoring Storage
                                                                                            Makro/{{ $productionBatch->po_number }}/{{ $productionBatch->production_date }}/{{ $blending->batch_range }}
                                                                                        </p>
                                                                                    </div>
                                                                                    <div
                                                                ...
                                                                <tr>
                                                                    <td>{{ $monitoring->batch_range }}
                                                                        @if ($monitoring->has_relation == true)
                                                                            <span class="badge bg-info text-dark ms-2">
                                                                                Merge {{ $monitoring->related_batches }}
                                                                                {{ $monitoring->additional_batches }}
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-primary"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#qrcode{{ $monitoring->id }}">
                                                                            QR Code {{ $monitoring->id }}
                                                                        </button>

                                                                        <!-- Modal Besar -->
                                                                        <div class="modal fade"
                                                                            id="qrcode{{ $monitoring->id }}"
                                                                            tabindex="-1"
                                                                            aria-labelledby="qrcodeLabel{{ $monitoring->id }}"
                                                                            aria-hidden="true">
                                                                            <div
                                                                                class="modal-dialog modal-dialog-centered modal-lg">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body text-center"
                                                                                        id="qrPrintArea{{ $monitoring->id }}">
                                                                                        <div
                                                                                            style="display: inline-block;">
                                                                                            <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG(url('analis/monitoring/blending/detail/data/id/' . $monitoring->id), 'QRCODE') }}"
                                                                                                alt="QR Code">
                                                                                        </div>
                                                                                        <p>Monitoring Storage
                                                                                            Mikro/{{ $productionBatch->po_number }}/{{ $productionBatch->production_date }}/{{ $monitoring->batch_range }}
                                                                                        </p>
                                                                                    </div>
                                                                                    <div
                                                                                        class="modal-footer justify-content-center py-2">
                                                                                        <button
                                                                                            onclick="printQR('qrPrintArea{{ $monitoring->id }}')"
                                                                                            class="btn btn-sm btn-success">Print</button>
                                                                                        <button type="button"
                                                                                            class="btn btn-sm btn-secondary"
                                                                                            data-bs-dismiss="modal">Close</button>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if (in_array($monitoring->disposition, ['Adjustment', 'Resampling', 'Leveling', 'Jalan Bareng']) &&
                                                                                $monitoring->revisi == null &&
                                                                                $monitoring->not_standar == true)
                                                                            <button
                                                                                class="btn btn-sm btn-warning generate-revisi-btn"
                                                                                data-id="{{ $monitoring->id }}"
                                                                                data-batch="{{ $monitoring->batch_range }}"
                                                                                data-po="{{ $monitoring->production_batch_id }}"
                                                                                data-disposition="{{ $monitoring->disposition }}">
                                                                                ❗
                                                                            </button>
                                                                        @else
                                                                        @endif
    ...
    <script>
        ...
        $(document).on('click', '.generate-revisi-btn', function() {
            ...
            $.get('{{ url('/analis/productionbatch/processmonitoringstorage/get-last-revisi') }}', {
                ...
                if (disposition === 'Leveling') {
                    ...
                    $.get('{{ url('/analis/productionbatch/processmonitoringstorage/get-available-additional-batch') }}', {
                        production_batch_id: poId,
                        exclude_batch: batch
                    }, function(batchRes) {
