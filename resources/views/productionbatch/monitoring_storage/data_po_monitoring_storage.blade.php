    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Monitoring Storage Kimia</h4>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-xxl-3 col-sm-3">
                                <div class="search-box">
                                    <input type="text" class="form-control" id="SearchData"
                                        placeholder="Cari nama Variant, nomor Po, atau lainnya...">
                            ...
                            <div class="dropdown col-xxl-2 col-sm-3">
                                ...
                                <div class="dropdown-menu p-3" aria-labelledby="dateFilterDropdown"
                                    ...
                                    <button type="button" class="btn btn-success w-100" id="filter-date-btn">Apply
                                        Filter</button>
                                </div>
                            </div>
                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($productionBatches as $index => $productionBatch)
                                        <tr>
                                            ...
                                            <td>{{ $productionBatch->isMonitoringStorageMakroComplete() ? '✅ Complete' : '⌛ Progress' }}
                                            </td>
                                            <td>
                                                <a href="{{ route('productionbatch.show_monitoring_storage', $productionBatch->id) }}"
                                                    class="btn btn-sm btn-info"><i class="ri-eye-line"></i></a>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-warning edit-btn"
                                                    data-id="{{ $productionBatch->id }}">
                            ...
                            <form id="form_input_po" class="tablelist-form">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3" id="modal-id">
                                        ...
                                        <input type="text" name="po_number" id="orderId" class="form-control"
                                            id="po_number" placeholder="Input nomor PO" required />
                                    </div>

                                    <div class="mb-3">
                                        <label for="variant" class="form-label">Variant</label>
                                        <input type="text" name="variant" id="variant" class="form-control"
                                            placeholder="Input variant" required />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="batch_range" id="batch_range" class="form-control"
                                            required placeholder="misal 1-2..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="storage" class="form-label">Storage</label>
                                        <input type="text" name="storage" id="storage" class="form-control"
                                            required placeholder="Input storage" />
                                    </div>

                                    <div class="mb-3">
                                        <label for="description" class="form-label">Keterangan</label>
                                        <input type="text" name="description" id="description" class="form-control"
                                            required placeholder="Input keterangan" />
                                    </div>
        ...
        `);
            ...
            function applyFilter() {
                ...
                const matchedRows = $('#orderTable tbody tr').filter(function() {
                    ...
                    const statusGGA = $(this).find('td').eq(6).text().trim().toLowerCase();
                    const statusGGAS = $(this).find('td').eq(7).text().trim().toLowerCase();
                    const includeStatus =
                        status === 'all' || status === '' ||
                        statusGGA.includes(status) || statusGGAS.includes(status);
