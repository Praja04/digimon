                    ...
                    <div>
                        <form id="form_input_po" class="tablelist-form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="batch_range" class="form-control" required
                                    placeholder="misal 1-12" id="batch_range_input" />
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            window.location =
                                '{{ url('analis/productionbatch/menu') }}'; // reload setelah klik "OK"
                        });
                    },
                    error: function(xhr) {
                        const handlers = {
