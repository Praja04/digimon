                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="text-muted">Tanggal Produksi : <span
                                                        class="text-body fw-medium">{{ $blending->productionBatch->production_date }}</span>
                                                </div>
                    ...
                    <div class="card-body">
                        <form class="ajax-blending-form" data-id="{{ $blending->id }}">
                            ...
                            <input type="hidden" name="url" id="url"
                                value="{{ $blending->production_batch_id }}">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-4">
                                    ...
                                    <input type="number" step="0.01" max="100" min="0" name="brix"
                                        id="brix" class="form-control" required
                                        value="{{ old('brix', $blending->brix) }}">
                                </div>

                                <div class="col-lg-4">
                                    <label for="nacl" class="form-label">NACL</label>
                                    <input type="number" step="0.01" max="100" min="0" name="nacl"
                                        id="nacl" class="form-control" required
                                        value="{{ old('nacl', $blending->nacl) }}">
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-label">Bj</label>
                                    <input type="number" step="0.01" max="100" min="0" name="bj"
                                        class="form-control" required>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-label">Visco</label>
                                    <input type="number" step="0.01" max="100" min="0" name="visco"
                                        class="form-control" required>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-label">Aw</label>
                                    <input type="number" step="0.01" max="100" min="0" name="aw"
                                        class="form-control" required>
                                </div>
                                <div class="col-lg-4">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.disposition-select').on('change', function() {
                ...
                const qtyInputs = $('.adjustment-qty');

                if (selected === 'Adjustment') {
                    qtyWrapper.removeClass('d-none');
                    // Tidak set required karena user bisa mengisi salah satu atau beberapa field saja
                    // qtyInputs.prop('required', true);
                } else {
                    qtyWrapper.addClass('d-none');
                    qtyInputs.prop('required', false).val('');
                }
            });
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            window.location.href =
                                "{{ url('/analis/blending/awal/detail') }}/" + url;
                        });
                    },
                    error: function(xhr) {
