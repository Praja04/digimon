                                    ...
                                    <form id="form-monitoring-input"
                                        ...
                                        <div class="modal-body row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="brix" id="brix" required>
                                            </div>

                                            <div class="col-md-6">
                                                <label for="nacl" class="form-label">NaCl</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="nacl" id="nacl" required>
                                            </div>

                                            <div class="col-md-6">
                                                <label for="bj" class="form-label">BJ</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="bj" id="bj" required>
                                            </div>

                                            <div class="col-md-6">
                                                <label for="visco" class="form-label">Visco</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="visco" id="visco">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="aw" class="form-label">AW</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="aw" id="aw">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="buih" class="form-label">Buih</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="buih" id="buih">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="ph" class="form-label">pH</label>
                                                <input type="text" class="form-control comma-input"
                                                    placeholder="Contoh: 0,00" name="ph" id="ph">
                                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" id="modal-disposisi-monitoring">
                                    <form id="pasteurisasiForm">
                                        ...
                                        @method('POST') {{-- Atau gunakan PUT jika kamu pakai update --}}
                                        <div class="modal-header">
                                            <h5 class="modal-title">Input Disposisi Monitoring Pasteurisasi</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-lihat').on('click', function() {
                ...
                $.ajax({
                    url: "{{ url('analis/monitoring/pasteurisasi/detail/data') }}" + '/' + id,
                    type: 'GET',
                    dataType: 'json',
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive mt-3">
                        ...
                        if (response.dataanalis.length > 0) {
            ...
            $('#form-monitoring-input').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('analis/monitoring/pasteurisasi/detail/data') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
            ...
            $('#pasteurisasiForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('/analis/monitoring/pasteurisasi/update/data') }}",
                    method: 'POST',
                    data: form.serialize(),
                    success: function(response) {
            ...
            $('#formEditMonitoring').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ url('analis/monitoring/pasteurisasi/detail/edit') }}", // Pastikan sesuai dengan route-mu
                    type: "POST",
                    data: formData,
                    dataType: "json",
                    headers: {
