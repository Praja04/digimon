                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-primary open-monitoring-modal" data-id="{{ $item->id }}">Input Analisa Monitoring Storage</button>
                                    @else
                            ...
                            <div class="modal fade" id="inputMonitoringModal" tabindex="-1" aria-labelledby="inputMonitoringModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="endapan" class="form-control" required oninput="this.value = this.value.toUpperCase();">
                                                </div>
                                                <div class="mb-3">
...
<script>
    $(document).ready(function() {
        ...
        $('#blendingForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('/analis/monitoring/storage/update/data')}}/" + selectedId,
                method: 'POST',
                data: form.serialize(),
