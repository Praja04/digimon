                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="text-muted">Tanggal Produksi : <span
                                                        class="text-body fw-medium">{{ $gga->productionBatch->production_date }}</span>
                                                </div>
                                            ...
                                            <div class="p-2 border border-dashed rounded">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h5 class="mb-0">{{ $gga->productionBatch->storage }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <select name="warna" class="form-select" required>
                                    ...
                                    @foreach ($manageWarna as $item)
                                        <option value="{{ $item->nama_warna }}"
                                            {{ $item->nama_warna == $gga->nama_warna ? 'selected' : '' }}>
                                            {{ $item->nama_warna }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('analis/ggaggas/gga') }}/" +
                                url;
                        });
                    },
                    error: function(xhr) {
